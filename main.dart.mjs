...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1290: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1300: (x0,x1) => x0.end(x1),
      _1301: x0 => x0.pause(),
      _1302: x0 => x0.play(),
      _1303: x0 => x0.load(),
      _1304: (x0,x1) => x0.removeAttribute(x1),
      _1305: (x0,x1) => x0.setSinkId(x1),
      _1318: x0 => x0.deviceMemory,
      _1319: Date.now,
      ...
      _1357: Object.is,
      _1358: o => o instanceof Array,
      _1363: a => a.pop(),
      _1364: (a, i) => a.splice(i, 1),
      _1365: (a, s) => a.join(s),
      _1366: (a, s, e) => a.slice(s, e),
      _1369: a => a.length,
      _1371: (a, i) => a[i],
      _1372: (a, i, v) => a[i] = v,
      _1374: o => o instanceof ArrayBuffer,
      _1375: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1377: o => o instanceof Uint8Array,
      _1378: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1379: o => o instanceof Int8Array,
      _1380: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1381: o => o instanceof Uint8ClampedArray,
      _1382: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1383: o => o instanceof Uint16Array,
      _1384: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1385: o => o instanceof Int16Array,
      _1386: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1387: o => o instanceof Uint32Array,
      _1388: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1389: o => o instanceof Int32Array,
      _1390: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1392: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1393: o => o instanceof Float32Array,
      _1394: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1395: o => o instanceof Float64Array,
      _1396: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1397: (t, s) => t.set(s),
      _1398: l => new DataView(new ArrayBuffer(l)),
      _1399: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1401: o => o.buffer,
      _1402: o => o.byteOffset,
      _1403: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1404: (b, o) => new DataView(b, o),
      _1405: (b, o, l) => new DataView(b, o, l),
      _1406: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1407: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1408: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1409: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1410: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1411: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1412: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1413: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1414: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1415: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1416: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1417: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1420: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1421: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1422: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1423: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1424: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1425: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1438: (ms, c) =>
      ...
      _1542: (o, p) => o[p],
      _1545: x0 => x0.random(),
      _1546: (x0,x1) => x0.getRandomValues(x1),
      _1547: () => globalThis.crypto,
      _1548: () => globalThis.Math,
      _1549: Function.prototype.call.bind(Number.prototype.toString),
      _1550: Function.prototype.call.bind(BigInt.prototype.toString),
      _1551: Function.prototype.call.bind(Number.prototype.toString),
      _1552: (d, digits) => d.toFixed(digits),
      _2330: x0 => x0.error,
      _2331: x0 => x0.src,
      _2332: (x0,x1) => { x0.src = x1 },
      _2340: (x0,x1) => { x0.preload = x1 },
      _2341: x0 => x0.buffered,
      _2344: x0 => x0.currentTime,
      _2345: (x0,x1) => { x0.currentTime = x1 },
      _2346: x0 => x0.duration,
      _2351: (x0,x1) => { x0.playbackRate = x1 },
      _2364: (x0,x1) => { x0.volume = x1 },
      _2381: x0 => x0.code,
      _2382: x0 => x0.message,
      _2456: x0 => x0.length,
      _3429: () => globalThis.window,
      _3492: x0 => x0.navigator,
      _3868: x0 => x0.maxTouchPoints,
      _3875: x0 => x0.appCodeName,
      _3876: x0 => x0.appName,
      _3877: x0 => x0.appVersion,
      _3878: x0 => x0.platform,
      _3879: x0 => x0.product,
      _3880: x0 => x0.productSub,
      _3881: x0 => x0.userAgent,
      _3882: x0 => x0.vendor,
      _3883: x0 => x0.vendorSub,
      _3885: x0 => x0.language,
      _3886: x0 => x0.languages,
      _3892: x0 => x0.hardwareConcurrency,
      _6032: x0 => x0.signal,
